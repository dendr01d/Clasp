...
namespace Clasp.Data.AbstractSyntax
{
    ...
    internal sealed class FunctionVerification : VmInstruction
    {
        ...
        public FunctionVerification(IEnumerable<CoreForm> arguments)
        {
        ...
        public override VmInstruction CopyContinuation() => new FunctionVerification(_arguments.Select(x => x.CopyContinuation() as CoreForm));
