...
namespace VirtualMachine
{
    ...
    {
        public static readonly int WordSize = sizeof(long);
        ...
        private Span<byte> _accumulator = new byte[WordSize];
        private Span<byte> _arg1 = new byte[WordSize];
        private Span<byte> _arg2 = new byte[WordSize];
