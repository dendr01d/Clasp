...
namespace ClaspCompiler.CompilerPasses
{
    ...
    //        if (op is Identifier id && _specialNames.Contains(id.BindingSymbol.Name))
    //        {
    ...
    //    {
    //        if (map.TryGetValue(scopes, id.FreeSymbol, out Symbol? bindingName))
    //        {
    ...
    //    {
    //        return op.BindingSymbol.Name switch
    //        {
